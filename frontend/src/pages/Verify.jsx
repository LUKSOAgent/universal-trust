        ...
        {!result && !loading && !inputValue && (
          <div className="mt-3">
            ...
            <div className="bg-lukso-card/50 border border-lukso-border/50 rounded-xl p-5 text-center">
              <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-4">What the scanner checks</p>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs text-gray-500">
                <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-lukso-darker/50 border border-lukso-border/30 hover:border-green-500/30 transition group">
                  <div className="w-10 h-10 rounded-full bg-green-500/10 border border-green-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                    <svg className="w-5 h-5 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  </div>
                  <span className="font-medium text-gray-400">Identity</span>
                  <span className="text-[10px] text-gray-600">Smart contract</span>
                </div>
                <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-lukso-darker/50 border border-lukso-border/30 hover:border-lukso-purple/30 transition group">
                  <div className="w-10 h-10 rounded-full bg-lukso-purple/10 border border-lukso-purple/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <span className="font-medium text-gray-400">Reputation</span>
                  <span className="text-[10px] text-gray-600">Endorsements + activity</span>
                </div>
                <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-lukso-darker/50 border border-lukso-border/30 hover:border-lukso-pink/30 transition group">
                  <div className="w-10 h-10 rounded-full bg-lukso-pink/10 border border-lukso-pink/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <span className="text-[10px] text-gray-600">Composite multi-source</span>
                </div>
                <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-lukso-darker/50 border border-lukso-border/30 hover:border-cyan-500/30 transition group">
                  <div className="w-10 h-10 rounded-full bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <span className="font-medium text-gray-400">On-Chain Activity</span>
                  <span className="text-[10px] text-gray-600">Envio indexer</span>
                </div>
              </div>
              <div className="mt-4 pt-3 border-t border-lukso-border/30 flex items-center justify-center gap-4 text-[10px] text-gray-600">
                <span className="flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-lukso-pink" />
                  AgentIdentityRegistry
                </span>
                <span className="flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-lukso-purple" />
                  Universal Profiles
                </span>
                <span className="flex items-center gap-1">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <p className="text-xs uppercase tracking-widest text-green-400/70 mb-1 flex items-center gap-2">
                      ...
                      Verified Agent — On-Chain Identity Confirmed
                    </p>
              ...
              <div className="relative z-10 p-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-lukso-border">
                  <div className="flex flex-wrap gap-3">
                    ...
                    <ShareButton address={address} name={result.name} trustScore={result.trustScore} />
                  </div>
...
function ShareButton({ address, name, trustScore }) {
  const [shared, setShared] = useState(false);

  async function handleShare() {
    const url = `${window.location.origin}/verify?address=${address}`;
    const text = `✅ ${name} — Trust Score: ${trustScore} | Verified on Universal Trust (LUKSO)`;
