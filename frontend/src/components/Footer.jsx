  ...
  return (
    <footer className="border-t border-lukso-border bg-lukso-darker mt-auto">
      <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="space-y-2">
              <div className="flex flex-col items-start gap-0.5 sm:flex-row sm:items-center sm:gap-2">
                ...
                <a
                  ...
                  className="inline-flex min-h-[44px] items-center font-mono text-xs text-lukso-purple hover:text-lukso-pink transition break-all"
          ...
          <div>
            ...
            <div className="space-y-1.5">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-[44px] items-center gap-1.5 py-2 text-xs text-gray-400 hover:text-white transition"
              >
        ...
        {/* Bottom row */}
        <div className="pt-4 border-t border-lukso-border/50 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-500">
          <span className="font-medium text-gray-500">Built for Synthesis 2026 — Agents that Trust track</span>
          <span>Last updated March 22, 2026 · v1.3.0</span>
        </div>
      </div>
    </footer>
  );
