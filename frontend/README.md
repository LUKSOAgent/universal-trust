...
|---|---|---|
| `VITE_CONTRACT_ADDRESS` | AgentIdentityRegistry proxy address | `0x16505FeC789F4553Ea88d812711A0E913D926ADD` |
...
```bash
# frontend/.env.local
VITE_CONTRACT_ADDRESS=0x16505FeC789F4553Ea88d812711A0E913D926ADD
